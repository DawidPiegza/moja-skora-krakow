...
import { eyebrowAndEyelashStylingCategoryViewData } from "./data/eyebrowAndEyelashStylingCategoryViewData";

export default function EyebrowAndEyelashStylingCategoryView() {
        ...
        <Grid size={12}>
          ...
          >
            <Grid size={12} paddingBottom={5} py={downMD ? 1 : 4} px={2}>
              ...
              >
                {language.webLanguage === "PL"
                  ? "Stylizacja brwi i rzęs".toUpperCase()
                  : "Eyebrow & eyelash styling".toUpperCase()}
              </Typography>
            </Grid>
          </Grid>
