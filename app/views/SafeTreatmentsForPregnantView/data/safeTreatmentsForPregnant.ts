import type { ISafeTreatmentsForPregnant } from "../utils/interfaces/ISafeTreatmentsForPregnant";

export const safeTreatmentsForPregnantPL: ISafeTreatmentsForPregnant = {
  description:
